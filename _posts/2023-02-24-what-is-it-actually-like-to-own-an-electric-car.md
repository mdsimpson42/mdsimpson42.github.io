---
title: "What is it actually like to own an Electric Car?"
...
![](/assets/img/blog/1-B_fuPBR_2z3NU_42QGPJBA-8c733da562.jpeg)
...
*I’ve done first impressions, a one-year update and a long-distance road-trip review of the car previously on this blog; *[check them out](https://mdsimpson.co.uk/category/electric-cars/)* if you’re interested.*
...
*TIP: A good place to look up a car’s range is *[EV Database](https://ev-database.org/uk/#sort:path~type~order=.rank~number~desc|range-slider-range:prev~next=0~600|range-slider-towweight:prev~next=0~2500|range-slider-acceleration:prev~next=2~23|range-slider-fastcharge:prev~next=0~1100|range-slider-eff:prev~next=150~500|range-slider-topspeed:prev~next=60~260|paging:currentPage=0|paging:number=9)*, which uses real-world data from actual drivers, and so gives more realistic estimates than the manufacturers!*

![](/assets/img/blog/1-yZL3zQPTUtpKMZDolzKgTg-f0899ece5b.jpeg)

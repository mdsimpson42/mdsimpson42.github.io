...
However, there have been a number of games where the launches have been a bit more problematic; games with balance issues, server instability or that were full of bugs. And it's not just MMOs, there are console games that have launched with unplayable multi-player and other major issues that were only fixed by patches later on. There has also been the launch of things like the *OUYA* console (as well as the *XBone* and *PS4*, come to that), where the console has launched with many issues, disabled features and without many games to play on it.

It's good to get a review out so that we know whether a product is worth adopting on day one, but a lot of things can change in the weeks and months following a product's launch. The *PS4* will get its blu-ray capability unlocked at some point soon, the *OUYA* could have had system updates to fix issues and more games released on its marketplace and an MMO could have had numerous expansions and updates to fix problems and add new content beyond what was there before, potentially fundamentally altering the game experience.

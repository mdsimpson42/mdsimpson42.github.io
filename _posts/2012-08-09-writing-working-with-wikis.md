...
The software I use is [MediaWiki](http://www.mediawiki.org/wiki/MediaWiki), which is the same technology that runs Wikipedia. In order to get this working you will either need your own website to host it, or (if you just want it to be a private thing) you can run your own web server locally (which is what I do). Its not as complicated as it may sound, but its not exactly simple to set up either.

The software I chose to host the wiki is called [WampServer](http://www.wampserver.com/en/). It is easy to set up and run, as it manages the server and database for you. There are various guides online that take you through the procedure (for example [this one](http://aeonier.wordpress.com/2008/06/11/media-wiki-installation-using-wamp-server/)). Alternatively, just contact your resident geek (everyone should have one!) and get him to do it for you!
